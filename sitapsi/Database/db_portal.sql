...
CREATE TABLE tb_anggota_kelas (
    ...
    no_urut INT NULL, -- [PENYESUAIAN: Ditambahkan untuk nomor urut absen siswa di kelas]
...
CREATE TABLE tb_riwayat_sp (
    ...
    id_admin INT, 
    catatan_admin TEXT NULL COMMENT 'Pesan spesifik dari Admin untuk Orang Tua', -- FIX: Typo dari ; diubah jadi ,
...
-- ================================================================
    ...
    CREATE TABLE tb_orang_tua (
        ...
        username VARCHAR(50) UNIQUE NOT NULL, -- [PENYESUAIAN: NIK Dihapus, Diganti Username Generate (Opsi 1)]
        password VARCHAR(255) NOT NULL, 
        nama_wali VARCHAR(150) NOT NULL, -- [PENYESUAIAN: Nama representatif yang pegang akun]
        nama_ayah VARCHAR(150),
        pekerjaan_ayah VARCHAR(100),
        nama_ibu VARCHAR(150),
        pekerjaan_ibu VARCHAR(100),
...
('admin', 'admin123', 'Admin Pusat Tatib', 'AdminPusat');
