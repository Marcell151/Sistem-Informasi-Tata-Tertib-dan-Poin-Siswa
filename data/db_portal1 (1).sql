...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Apr 2026 pada 15.33
...
CREATE TABLE `tb_admin` (
  ...
  `role` enum('AdminPusat','Admin') DEFAULT 'Admin',
...
(1, 'admin', 'admin123', 'Admin SITAPSI', 'AdminPusat', '2026-04-12 06:35:14'),
(2, 'admintatib', 'admin123', 'Tim Kedisiplinan', 'Admin', '2026-04-12 06:35:14');
...
(1, '2024001', 1, 1, 200, 100, 250, 550, 'Aman', 'SP1', 'SP1', 'SP1', 'None'),
(2, '2025002', 2, 1, 0, 0, 0, 0, 'Aman', 'Aman', 'Aman', 'Aman', 'None'),
(3, '11223', 1, 1, 0, 0, 0, 0, 'Aman', 'Aman', 'Aman', 'Aman', 'None'),
...
(1, 1, 2, 'error', '2026-04-12 13:38:40', 'Sudah Dibaca', 2);
...
(1, '3573012345678901', 'e10adc3949ba59abbe56e057f20f883e', 'Bpk. Dani', 'Swasta', 'Ibu Dani', 'Ibu Rumah Tangga', '081234567890', 'Jl. Merdeka No. 1, Malang', '2026-04-12 06:35:14');
...
(1, 1, 5, 1, '2026-04-12', '13:35:00', 'Ganjil', 'Piket', NULL, NULL, 'None', NULL),
(2, 1, 5, 1, '2026-04-12', '13:36:00', 'Ganjil', 'Kelas', NULL, NULL, 'None', NULL);
...
(1, 1, 'SP1', 'KERAJINAN', '2026-04-12', NULL, 'Pending', NULL, NULL),
(2, 1, 'SP1', 'KERAPIAN', '2026-04-12', NULL, 'Pending', NULL, 'Test'),
(3, 1, 'SP1', 'KERAJINAN', '2026-03-12', NULL, 'Pending', NULL, NULL),
(4, 1, 'SP1', 'KERAPIAN', '2026-03-12', NULL, 'Pending', NULL, NULL),
(5, 31, 'SP1', 'KERAJINAN', '2026-03-16', NULL, 'Pending', NULL, NULL),
(6, 31, 'SP1', 'KERAPIAN', '2026-03-16', NULL, 'Pending', NULL, NULL),
(7, 30, 'SP1', 'KELAKUAN', '2026-03-16', NULL, 'Pending', NULL, NULL);
...
--
ALTER TABLE `tb_anggota_kelas`
  MODIFY `id_anggota` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
